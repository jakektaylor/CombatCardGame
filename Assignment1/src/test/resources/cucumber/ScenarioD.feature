Feature: ScenarioD
  Scenario: ScenarioD
    ...
    And set initial health points at 70

    #Round 1------------------------------------------------------------------------------------------------------------
    When we begin the first round and distribute 12 cards to each player in Scenario "D"
    #-------Melee 1-----------------------------------------------------------------------------------------------------
    And "P1" plays "Ar1"
    And "P2" plays "Ar2"
    And "P3" plays "Ar3"
    ...
    And "P3" plays "De15"
    And "P1" plays "De14"
    And "P3" is the loser and accumulates 15 injury points from Melee 12

    And round 1 ends
    #Game over----------------------------------------------------------------------------------------------------------
    Then the Game ends after round 1
    And  "P2" is the winner